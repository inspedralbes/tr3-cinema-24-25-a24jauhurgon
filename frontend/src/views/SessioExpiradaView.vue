...
<template>
  <div class="min-h-screen flex items-center justify-center relative overflow-hidden">
    <!-- Fons -->
    <div class="absolute inset-0 bg-gradient-to-br from-red-900/10 via-[var(--color-background-dark)] to-red-900/5"></div>

    <main class="relative z-10 max-w-lg w-full px-6 text-center">
      <!-- Icona d'error -->
      <div class="mb-8">
        <div class="w-24 h-24 mx-auto rounded-full bg-red-500/20 border-4 border-red-500/40 flex items-center justify-center mb-6">
        ...
        <p class="text-slate-400 text-lg max-w-md mx-auto">
          El temps assignat per completar la reserva ha finalitzat. Els seients seleccionats s'han alliberat automàticament.
        </p>
      </div>
      ...
      <div class="flex flex-col gap-3">
        ...
        <button class="w-full border border-white/10 hover:bg-white/5 py-3 rounded-xl font-semibold text-slate-300 transition-all"
                @click="tornarLogin">
          Tornar a l'inici
        </button>
      </div>
